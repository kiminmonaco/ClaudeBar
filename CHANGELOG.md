...
### Fixed
- Rebuild appcast.xml without old entries
- Remove build number check from update-appcast

## [0.2.3] - 2025-12-24

### Fixed
- Use GitHub run number as build number for consistent versioning
...
### Added
- Initial Sparkle setup for auto-updates
